...
fn format_options(name: &str, core: &mut ShellCore) -> String {
...
fn output(core: &mut ShellCore, name: &str, args: &[String]) {
...
pub(super) fn names_match(core: &mut ShellCore, names: &mut Vec<String>, args: &[String]) -> i32 {
...
pub(super) fn f_option(core: &mut ShellCore, args: &[String], subs: &mut [Substitution]) -> i32 {
    if subs.is_empty() {
